...
TEST_F(test_exp_multisampled_texture2_array, size_constructor_size_limits)
{
  vec3u min_size(1u, 1u, 1u);
...
TEST_F(test_exp_multisampled_texture2_array_death_test,
  size_constructor_invalid_size)
{
...
TEST_F(test_exp_multisampled_texture2_array, full_size_constructor)
{
...
TEST_F(test_exp_multisampled_texture2_array,
  full_size_constructor_sample_count_limits)
{
  vec3u size_ref(4u, 8u, 2u);
...
TEST_F(test_exp_multisampled_texture2_array_death_test, invalid_sample_count)
{
  EXPECT_PRECOND_ERROR(
...
TEST_F(test_exp_multisampled_texture2_array, get_byte_count)
{
  vec3u size_ref(4u, 8u, 2u);
  for(auto tf : all_formats)
  {
