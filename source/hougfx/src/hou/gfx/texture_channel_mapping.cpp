...
texture_channel_mapping::texture_channel_mapping(texture_channel r,
  texture_channel g, texture_channel b, texture_channel a) noexcept
  : m_r(r)
  , m_g(g)
  , m_b(b)
  , m_a(a)
...
texture_channel texture_channel_mapping::get_r() const noexcept
{
  return m_r;
}
...
texture_channel texture_channel_mapping::get_g() const noexcept
{
  return m_g;
}
...
texture_channel texture_channel_mapping::get_b() const noexcept
{
  return m_b;
}
...
texture_channel texture_channel_mapping::get_a() const noexcept
{
  return m_a;
}
...
void texture_channel_mapping::set_r(texture_channel channel) noexcept
{
  m_r = channel;
}
...
void texture_channel_mapping::set_g(texture_channel channel) noexcept
{
  m_g = channel;
}
...
void texture_channel_mapping::set_b(texture_channel channel) noexcept
{
  m_b = channel;
}
...
void texture_channel_mapping::set_a(texture_channel channel) noexcept
{
  m_a = channel;
}
