...
positive<uint> texture2::get_mipmap_level_count() const noexcept
{
...
positive<uint> multisampled_texture2::get_sample_count() const noexcept
{
...
positive<uint> mipmapped_texture3::get_mipmap_level_count() const noexcept
{
  return m_mipmap_level_count;
}
...
positive<uint> multisampled_texture2_array::get_sample_count() const noexcept
{
  return m_sample_count;
}
