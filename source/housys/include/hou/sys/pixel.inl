...
extern template class HOU_SYS_API pixel_t<pixel_format::r>;
extern template class HOU_SYS_API pixel_t<pixel_format::rg>;
extern template class HOU_SYS_API pixel_t<pixel_format::rgb>;
extern template class HOU_SYS_API pixel_t<pixel_format::rgba>;

template <>
template <>
HOU_SYS_API pixel_t<pixel_format::r>::pixel_t(
...
template <>
template <>
HOU_SYS_API pixel_t<pixel_format::rg>::pixel_t(
...
template <>
template <>
HOU_SYS_API pixel_t<pixel_format::rgb>::pixel_t(
  const pixel_t<pixel_format::r>& other) noexcept;
...
template <>
template <>
HOU_SYS_API pixel_t<pixel_format::rgba>::pixel_t(
  const pixel_t<pixel_format::r>& other) noexcept;
...
HOU_SYS_API std::ostream& operator<<(
  std::ostream& os, const pixel_t<pixel_format::r>& pixel);

template <>
HOU_SYS_API std::ostream& operator<<(
  std::ostream& os, const pixel_t<pixel_format::rg>& pixel);

template <>
HOU_SYS_API std::ostream& operator<<(
  std::ostream& os, const pixel_t<pixel_format::rgb>& pixel);

template <>
HOU_SYS_API std::ostream& operator<<(
  std::ostream& os, const pixel_t<pixel_format::rgba>& pixel);
