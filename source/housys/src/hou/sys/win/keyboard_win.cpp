...
UINT key_code_to_win_key(key_code key)
{
  switch(key)
  {
    ...
    case key_code::Apps:
      return VK_APPS;
    case key_code::LSystem:
      return VK_LWIN;
    case key_code::RSystem:
      return VK_RWIN;
    ...
    case key_code::Convert:
      return VK_CONVERT;
    case key_code::NonConvert:
      return VK_NONCONVERT;
    case key_code::Accept:
      return VK_ACCEPT;
    case key_code::ModeChange:
      return VK_MODECHANGE;
    case key_code::ProcessKey:
      return VK_PROCESSKEY;

    case key_code::BrowserBack:
      return VK_BROWSER_BACK;
    case key_code::BrowserForward:
      return VK_BROWSER_FORWARD;
    case key_code::BrowserRefresh:
      return VK_BROWSER_REFRESH;
    case key_code::BrowserStop:
      return VK_BROWSER_STOP;
    case key_code::BrowserSearch:
      return VK_BROWSER_SEARCH;
    case key_code::BrowserFavorites:
      return VK_BROWSER_FAVORITES;
    case key_code::BrowserHome:
      return VK_BROWSER_HOME;

    case key_code::VolumeUp:
      return VK_VOLUME_UP;
    case key_code::VolumeDown:
      return VK_VOLUME_DOWN;
    case key_code::VolumeMute:
      return VK_VOLUME_MUTE;

    case key_code::MediaNextTrack:
      return VK_MEDIA_NEXT_TRACK;
    case key_code::MediaPreviousTrack:
      return VK_MEDIA_PREV_TRACK;
    case key_code::MediaStop:
      return VK_MEDIA_STOP;
    case key_code::MediaPlayPause:
      return VK_MEDIA_PLAY_PAUSE;
    case key_code::LaunchMediaSelect:
      return VK_LAUNCH_MEDIA_SELECT;
    case key_code::LaunchMail:
      return VK_LAUNCH_MAIL;
    case key_code::LaunchApp1:
      return VK_LAUNCH_APP1;
    case key_code::LaunchApp2:
