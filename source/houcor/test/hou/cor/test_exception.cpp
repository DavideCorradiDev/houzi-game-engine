...
{
#ifdef NDEBUG
  EXPECT_NO_ERROR(HOU_DEV_CHECK_STD_0(0 == 2, std::exception));
#else
  EXPECT_ERROR_STD_0(
...
{
#ifdef NDEBUG
  EXPECT_NO_ERROR(HOU_DEV_CHECK_STD_N(0 == 2, std::runtime_error, "Message."));
#else
  EXPECT_ERROR_STD_N(
...
{
#ifdef NDEBUG
  EXPECT_NO_ERROR(HOU_DEV_CHECK_0(0 == 2, exception_0_args));
#else
  EXPECT_ERROR_0(HOU_DEV_CHECK_0(0 == 2, exception_0_args), exception_0_args);
#endif
}
...
{
#ifdef NDEBUG
  EXPECT_NO_ERROR(HOU_DEV_CHECK_N(0 == 2, exception_2_args, 88, 'a'));
#else
  EXPECT_ERROR_N(HOU_DEV_CHECK_N(0 == 2, exception_2_args, 88, 'a'),
