...
/** Outputs a duration in nanoseconds to the given ph_stream.
 *
...
/** Outputs a duration in microseconds to the given ph_stream.
 *
 *  \tparam Rep the internal representation of the duration.
 *  \param os the output ph_stream.
 *  \param d the duration.
...
/** Outputs a duration in milliseconds to the given ph_stream.
 *
 *  \tparam Rep the internal representation of the duration.
 *  \param os the output ph_stream.
 *  \param d the duration.
...
/** Outputs a duration in seconds to the given ph_stream.
 *
 *  \tparam Rep the internal representation of the duration.
 *  \param os the output ph_stream.
 *  \param d the duration.
...
/** Outputs a duration in minutes to the given ph_stream.
 *
 *  \tparam Rep the internal representation of the duration.
 *  \param os the output ph_stream.
 *  \param d the duration.
...
/** Outputs a duration in hours to the given ph_stream.
 *
 *  \tparam Rep the internal representation of the duration.
 *  \param os the output ph_stream.
 *  \param d the duration.
...
#include "hou/cor/std_chrono.inl"
