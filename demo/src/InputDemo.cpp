...
int main()
{
  ...
  hou::RenderContext::setCurrent(ctx);
  ...
  hou::Texture2 keyboardTex(hou::pngReadFile<hou::PixelFormat::RGBA>("demo/data/keyboard.png"));
  hou::Texture2 keyboardKeysTex(hou::pngReadFile<hou::PixelFormat::RGBA>("demo/data/keyboardkeys.png"));
  hou::Texture2 mouseTex(hou::pngReadFile<hou::PixelFormat::RGBA>("demo/data/mouse.png"));
  hou::Texture2 mousebuttonsTex(hou::pngReadFile<hou::PixelFormat::RGBA>("demo/data/mousebuttons.png"));

  hou::Font font(std::make_unique<hou::BinaryFileIn>("demo/data/NotoMono-Regular.ttf"));

  hou::Mesh2 keyboardQuad = hou::createTextureQuadMesh2
    ( hou::Rectf(0, 0, keyboardTex.getSize().x(), keyboardTex.getSize().y())
    , keyboardTex.getSize());
  hou::Mesh2 key1Quad = hou::createTextureQuadMesh2
    ( hou::Rectf(72, 0, 16, 16)
    , keyboardKeysTex.getSize());
  ...
  hou::Mesh2 mouseQuad = hou::createTextureQuadMesh2
    ( hou::Rectf(0, 0, mouseTex.getSize().x(), mouseTex.getSize().y())
    , mouseTex.getSize());
  hou::Mesh2 mouseBtnQuad = hou::createTextureQuadMesh2
    ( hou::Rectf(0, 0, 16, 25)
    , mousebuttonsTex.getSize());
  ...
  hou::Trans2f projTrans = hou::Trans2f::orthographicProjection(hou::Rectf(0.f, 0.f, wnd.getSize().x()
    , wnd.getSize().y()));
