 ...
 *
 *  Supported formats: TTF, TTC, CFF, WOFF, OTF, OTC, PFA, PFB, CID-keyed Type 1,
 *  SFNT-based bitmap fonts, X11 PCF, Windows FNT, BDF, PFR.
 *
 *  All metrics are expressed in 26.6 pixel format, which means the unit is
 *  1/64th of pixel.
 */
class HOU_GFX_API Font
  : public NonCopyable
{
public:
  ...
  /** Get a bounding box capable of containing any glyph in the font.
   *
